        ...
        <div class="row justify-content-center">
          <div class="col-sm-12 col-md-8 col-lg-8 col-xl-7 mx-auto">
            ...
            <div class="card border rounded bg-light p-5">
              <div class="card-body">
                <form action="app/php/conexion3.php" method="POST">
                  <div class="form-group">
                      <label for="">Buscar:</label>
                      <div class="input-group">

                          <input type="text" id="buscar" name="buscar" class="form-control" @keyup.enter="buscar" v-model="txtBuscador" placeholder="Buscar por el nombre de la empresa" />
                      ...
                      <div class="mt-5 h3" style="text-align: right;">
                        <a class="a" href="app/php/menu.php"><i class="fa-regular fa-circle-left"></i> Regresar</a> 
                      </div>
                  </div>
              </form>
              </div>
            ...
            <div v-for="(liDatos, index) in datos">
              ...
              <div class="card border rounded bg-light my-3" style="font-size: 1em;">
                <div class="card-body">              
                <div style="background-color:#34D9C3; text-align: center; text-transform: uppercase;"><h1>cotizacion</h1></div>
...
$cs3 = $conConTabla -> query("SELECT * FROM buscar ORDER BY id DESC LIMIT 1");
  while ($resul = $cs3 -> fetchArray()) {
    $buscar=$resul['buscar'];
  }
$cs2 = $conConTabla -> query("SELECT * FROM cotizacion WHERE nomEmp='$buscar'");
    ...
    echo '											
															<tr>
                                                                ...
                                                                <td>'.$Fecha.'</td>
                                                                <td><a href="javascript:genPDF()" method="POST" type="file" name="archivo" id="archivo" type="button" class="btn btn-primary">
